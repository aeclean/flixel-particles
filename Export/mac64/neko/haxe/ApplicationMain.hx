...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Company Name", "Particles", "br.com.locomotivemobile.samples.particles", "1.0.0");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Particles", null, { width: 800, height: 600 });
